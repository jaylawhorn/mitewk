#ifndef EWKANA_NTUPLER_SCNTUPLERMOD_H
#define EWKANA_NTUPLER_SCNTUPLERMOD_H
...
namespace mithep
{  
  class SCNtuplerMod : public BaseMod
  {    
    public:
      SCNtuplerMod(const char *name="SCNtuplerMod", const char *title="BAMBU to ntuple");
      ~SCNtuplerMod();	    
...
>>>>>>> 73ecf38fbabb525fd7faab1c6457f2661f15464f
    ...
    protected:
      ...
      // Fill SC data object
      void FillSC(const SuperCluster *sc);
...
>>>>>>> 73ecf38fbabb525fd7faab1c6457f2661f15464f
      ...
      TClonesArray           *fSCArr;           // supercluster array
