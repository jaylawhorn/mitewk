 ...
 *
 * Example usage:
 *   root -l -q -b runSCNtupler.C+\(\"0000\",\"f11-h250zz2l-gf-v14b-pu\",\"cern/filefi/025\",\"/home/mitprod/catalog\",0,1,0,-1,0\)
 *
 * Output file name has standard format: <dataset>_<fileset>_ntuple.root
 *
 */
void runSCNtupler_test(
  ...
  )
{
  ...
  char output[100];
  sprintf(output,"%s_%s_scntuple.root",dataset,fileset); 
 ...
 *
 */
void runSCNtupler_test(const char *file   = "root://xrootd.cmsaf.mit.edu//store/user/paus/filefi/029/r12a-sel-j22-v1/00176847-0073-E211-9FFE-0030487DE7C5.root",
		       const char *output = "scntuple.root",
		       Bool_t isData      = kTRUE,
		       Int_t  useGen      = 0,
		       Int_t  fsrmode     = 0,
		       Int_t  nevents     = -1,
