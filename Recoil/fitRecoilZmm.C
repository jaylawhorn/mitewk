...
<<<<<<< HEAD
  ...
  fcnPFu1sigma2->SetParameter(2,9.5);   fcnPFu1sigma2->SetParLimits(2,5,17);
  ...
  fcnPFu1sigma0->SetParameter(2,7);     fcnPFu1sigma0->SetParLimits(2,5,11); 
  ...
  fcnPFu2sigma1->SetParameter(2,7);      fcnPFu2sigma1->SetParLimits(2,2,17);
  ...
  fcnPFu2sigma2->SetParameter(2,9);      fcnPFu2sigma2->SetParLimits(2,5,17);
