...
<<<<<<< HEAD
  ...
  const TString zmmHLTEffName_neg  = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zmm_MuHLTEff_neg/analysis/eff.root";
  
  const TString dataSelEffName_pos = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_MuSelEff_pos/analysis/eff.root";
  const TString dataSelEffName_neg = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_MuSelEff_neg/analysis/eff.root";
  const TString zmmSelEffName_pos  = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zmm_MuSelEff_pos/analysis/eff.root";
  const TString zmmSelEffName_neg  = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zmm_MuSelEff_neg/analysis/eff.root";
  
  const TString dataTrkEffName_pos = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_MuTrkEff_pos/analysis/eff.root";
  const TString dataTrkEffName_neg = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_MuTrkEff_neg/analysis/eff.root";
  const TString zmmTrkEffName_pos  = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zmm_MuTrkEff_pos/analysis/eff.root";
  const TString zmmTrkEffName_neg  = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zmm_MuTrkEff_neg/analysis/eff.root";
  
  const TString dataStaEffName_pos = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_MuStaEff_iso_pos/analysis/eff.root";
