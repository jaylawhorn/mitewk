...
<<<<<<< HEAD
  ...
  TString zmmSelEffName("/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zmm_MuSelEff/analysis/eff.root");
  TString dataTrkEffName("/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_MuTrkEff/analysis/eff.root");
  TString zmmTrkEffName("/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zmm_MuTrkEff/analysis/eff.root");
  TString dataStaEffName("/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_MuStaEff_iso/analysis/eff.root");
  TString zmmStaEffName("/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zmm_MuStaEff_iso/analysis/eff.root");
  if(charge==1) {
    dataHLTEffName = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_MuHLTEff_pos/analysis/eff.root";
    zmmHLTEffName  = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zmm_MuHLTEff_pos/analysis/eff.root";
    dataSelEffName = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_MuSelEff_pos/analysis/eff.root";
    zmmSelEffName  = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zmm_MuSelEff_pos/analysis/eff.root";
    dataTrkEffName = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_MuTrkEff_pos/analysis/eff.root";
    zmmTrkEffName  = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zmm_MuTrkEff_pos/analysis/eff.root";
    dataStaEffName = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_MuStaEff_iso_pos/analysis/eff.root";
    zmmStaEffName  = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zmm_MuStaEff_iso_pos/analysis/eff.root";
  }
  if(charge==-1) {
    dataHLTEffName = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_MuHLTEff_neg/analysis/eff.root";
    zmmHLTEffName  = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zmm_MuHLTEff_neg/analysis/eff.root";
    dataSelEffName = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_MuSelEff_neg/analysis/eff.root";
    zmmSelEffName  = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zmm_MuSelEff_neg/analysis/eff.root";
    dataTrkEffName = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_MuTrkEff_neg/analysis/eff.root";
