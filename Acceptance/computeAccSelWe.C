...
void computeAccSelWe(const TString conf,       // input file
  ...
  TString zeeGsfSelEffName("/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zee_EleGsfSelEff/analysis/eff.root");
  if(charge==1) {
    dataHLTEffName = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_EleHLTEff_pos/analysis/eff.root";
    zeeHLTEffName  = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zee_EleHLTEff_pos/analysis/eff.root";
    dataGsfSelEffName = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_EleGsfSelEff_pos/analysis/eff.root";
    zeeGsfSelEffName  = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zee_EleGsfSelEff_pos/analysis/eff.root";
  }
  if(charge==-1) {
    dataHLTEffName = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_EleHLTEff_neg/analysis/eff.root";
