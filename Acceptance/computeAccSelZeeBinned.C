...
void computeAccSelZeeBinned(const TString conf,            // input file
  ...
  const TString zeeHLTEffName      = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zee_EleHLTEff/analysis/eff.root";
  const TString zeeHLTEffName_pos  = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zee_EleHLTEff_pos/analysis/eff.root";
  const TString zeeHLTEffName_neg  = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/Zee_EleHLTEff_neg/analysis/eff.root";
  
  const TString dataGsfSelEffName     = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_EleGsfSelEff/analysis/eff.root";
  const TString dataGsfSelEffName_pos = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_EleGsfSelEff_pos/analysis/eff.root";
  const TString dataGsfSelEffName_neg = "/scratch/klawhorn/EWKAnaR12a/EfficiencyResults/R12a_EleGsfSelEff_neg/analysis/eff.root";
