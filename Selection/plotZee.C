...
void plotZee(const TString  conf,            // input file
...
>>>>>>> 73ecf38fbabb525fd7faab1c6457f2661f15464f
  ...
  for(UInt_t icat=0; icat<5; icat++) {
    ...
    // Tag lepton pT
    //
    if(icat==0) sprintf(xlabel,"leading electron p_{T} [GeV/c]");
    else        sprintf(xlabel,"tag electron p_{T} [GeV/c]");
    ...
    // Tag lepton eta
    //
    if(icat==0) sprintf(xlabel,"leading electron #eta");
    else        sprintf(xlabel,"tag electron #eta");
    ...
    // Tag lepton phi
    //
    if(icat==0) sprintf(xlabel,"leading electron #phi");
    else        sprintf(xlabel,"tag electron #phi");
    ...
    // Probe lepton pT
    //
    if(icat==0) sprintf(xlabel,"trailing electron p_{T} [GeV/c]");
    else        sprintf(xlabel,"probe electron p_{T} [GeV/c]");
    ...
    // Probe lepton eta
    //
    if(icat==0) sprintf(xlabel,"trailing electron #eta");
    else        sprintf(xlabel,"probe electron #eta");
    ...
    // Probe lepton phi
    //
    if(icat==0) sprintf(xlabel,"trailing electron #phi");
    else        sprintf(xlabel,"probe electron #phi");
  ...
  CPlot plotMassBB(pname,"","m(e^{+}e^{-}) [GeV/c^{2}]",ylabel);
  ...
  CPlot plotMassBE(pname,"","m(e^{+}e^{-}) [GeV/c^{2}]",ylabel);
  ...
  CPlot plotMassEE(pname,"","m(e^{+}e^{-}) [GeV/c^{2}]",ylabel);
...
void makeHTML(const TString outDir)
{
  ...
  htmlfile << "</tr>" << endl;
  htmlfile << "<tr>" << endl;
  htmlfile << "<td width=\"25%\"><a target=\"_blank\" href=\"cat0.html\">Selected Zee</a></td>" << endl;
  ...
  htmlfile << "<table border=\"0\" cellspacing=\"5\" width=\"100%\">" << endl; 
  htmlfile << "<tr>" << endl;
  htmlfile << "<td width=\"25%\"><a target=\"_blank\" href=\"plots/zmass_cat1.png\"><img src=\"plots/zmass_cat1.png\" alt=\"plots/zmass_cat1.png\" width=\"100%\"></a></td>" << endl;
  htmlfile << "<td width=\"25%\"><a target=\"_blank\" href=\"plots/zmass_cat2.png\"><img src=\"plots/zmass_cat2.png\" alt=\"plots/zmass_cat2.png\" width=\"100%\"></a></td>" << endl;
  htmlfile << "<td width=\"25%\"><a target=\"_blank\" href=\"plots/zmass_cat3.png\"><img src=\"plots/zmass_cat3.png\" alt=\"plots/zmass_cat3.png\" width=\"100%\"></a></td>" << endl;
